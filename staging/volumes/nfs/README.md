...
See [NFS Service and Replication Controller](nfs-web-deployment.yaml) for a quick example of how to use an NFS
...
Define [the NFS Service and Replication Controller](nfs-server-deployment.yaml) and
